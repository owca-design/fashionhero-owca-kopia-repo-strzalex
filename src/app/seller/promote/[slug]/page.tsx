...
export default function PromotePage({ params }: { params: { slug: string } }) {
      ...
      <div className="mt-8 grid md:grid-cols-[1fr_320px] gap-10 items-start">
        <div>
          ...
          <div className="mt-8 grid sm:grid-cols-3 gap-3">
            {[
              { icon: Tag, label: "Cena od", value: "49 zł", sub: "za kampanię", color: "#6B6B6B" },
              { icon: Clock, label: "Czas trwania", value: "7 dni", sub: "domyślnie", color: "#6B6B6B" },
              { icon: TrendingUp, label: "Szac. wzrost", value: "3×", sub: "więcej wyświetleń", color: "#1E7C3A" },
